...
/**
 * Unit Test for PartitionOrderedExecutorService.
 */
public class PartitionOrderedExecutorServiceTest {
    ...
    public void testEmptyScenario() {
        ...
        PartitionOrderedExecutorService<String> executorService = new PartitionOrderedExecutorService<String>(messageHandler, configuration);
        try {
    ...
    public void testSinglePartitionScenario() {
        ...
        try {
            ...
            assertTrue(1 == messageHandler.threadIdMap.size());
        } catch (InterruptedException e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
